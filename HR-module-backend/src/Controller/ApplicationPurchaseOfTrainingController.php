...
class ApplicationPurchaseOfTrainingController extends AbstractController
{
    ...
    #[Route('/{id}', name: 'app_applicationPurchaseOfTraining_find', methods: "GET")]
    ...
    public function removeApplicationPurchaseOfTraining($id, Request $request, ManagerRegistry  $doctrine): Response
    {
        $entityManager = $doctrine->getManager();
