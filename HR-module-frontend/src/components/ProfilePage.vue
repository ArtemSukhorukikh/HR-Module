        ...
        <div class="col-md-4 mb-3">
          ...
          <div class="card mt-3">
            <div class="row-cols-2 d-flex justify-content-around">
              <p>Контакты</p>
              <svg v-if="currentUser" @click='openModalContact("new", {})' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mt-1 bi bi-plus-circle" viewBox="0 0 16 16">
