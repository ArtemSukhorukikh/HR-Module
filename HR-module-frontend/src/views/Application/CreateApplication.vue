                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4">
                        ...
                        <label>Способ прохождения</label>
                        <select class="form-select form-select-sm" aria-label=".form-select-sm example" v-model="applicationDTO.method_of_passage">
                          <option value="1">На рабочем месте</option>
                          <option value="2">Удаленно</option>
                        </select>

                        <button @click="sendApplication" class="w-100 btn btn-lg btn-primary" type="submit">Отправить заявку</button>
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4">
                        ...
                        <div class="form-floating">
                          <input v-model="applicationPOPTDTO.description" type="text" class="form-control" id="floatingPassword" placeholder="Примечание">
                        ...
                        <button @click="sendApplicationPOPT" class="w-100 btn btn-lg btn-primary" type="submit">Отправить заявку</button>
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4">
                        ...
                        <button @click="sendApplicationPOT" class="w-100 btn btn-lg btn-primary" type="submit">Отправить заявку</button>
    ...
    sendApplicationPOT() {
      ...
      axios
          .post('http://localhost:84/api/v1/applicationPOT/new',{
            id: '',
            user_id: localStorage.getItem('userId'),
            description: this.applicationPOPTDTO.description,
            link: this.applicationPOPTDTO.link,
            note: this.applicationPOPTDTO.note,
            status: '0'})
          .then(response => {
